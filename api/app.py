...
model = joblib.load('/home/machou/openclassroom/mlflow_project/models/xgb_model_with_smote_and_score_metier_etape_par_etape.pkl')  # Assurez-vous que le modèle est déjà sauvegardé en utilisant joblib
# Charger le préprocesseur (si vous en avez un)
preprocessor = joblib.load('/home/machou/openclassroom/mlflow_project/models/preprocessor.pkl')
